    ...
    <section className="nl" aria-labelledby="nl-title">
      <div className="wrap nl__grid">
        ...
        <div className="nl__form-col">
          <h2 className="nl__heading" id="nl-title">Weekly Newsletter</h2>
          <p className="nl__tagline">New Arrivals, Hot Deals &amp; Expert Tips</p>
          <p className="nl__desc">
            We're committed to help you grow your brand. Get new arrivals, exclusive offers, and
            the latest trends in promotional products weekly.
          </p>
          ...
          {done ? (
            ...
            <form className="nl__form" onSubmit={submit} noValidate aria-label="Subscribe to newsletter">
              <label htmlFor="nl-email" className="sr-only">Email address</label>
              <div className={`nl__input-wrap${error ? ' nl__input-wrap--err' : ''}`}>
                <input
                  id="nl-email"
                  type="email"
                  className="nl__input"
        ...
        <a href="#" className="nl__banner nl__banner--travel" aria-label="Travel Accessories — View Products">
          <img
          ...
          <div className="nl__banner-body">
            <h3>Travel<br />Accessories</h3>
            <span className="nl__banner-cta">View Products</span>
          </div>
        </a>

        {/* ── Col 3: Gift Sets banner ── */}
        <a href="#" className="nl__banner nl__banner--gifts" aria-label="Gift Sets Collection 2025 — Shop Now">
          <img
