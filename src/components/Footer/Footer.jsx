      ...
      <div className="footer__main">
        <div className="wrap footer__grid">
          ...
          <nav className="footer__col" aria-labelledby="fc-cats">
            <h3 className="footer__col-title" id="fc-cats">
              Categories
            </h3>
          ...
          <nav className="footer__col" aria-labelledby="fc-svc">
            <h3 className="footer__col-title" id="fc-svc">
              Services
            </h3>
            <ul className="footer__links" role="list">
              {COLS.SERVICES.map((l) => (
          ...
          <nav className="footer__col" aria-labelledby="fc-tools">
            <h3 className="footer__col-title" id="fc-tools">
              Tools
            </h3>
            <ul className="footer__links" role="list">
              {COLS.TOOLS.map((l) => (
          ...
          <div className="footer__col" aria-labelledby="fc-contact">
            <h3 className="footer__col-title" id="fc-contact">
              Contact
            </h3>
            <address
            ...
            >
              ...
              <a
                href="mailto:info@onlineshopping.com"
      ...
      <div className="footer__bottom">
        <div className="wrap footer__bottom-row">
          ...
          <a
            ...
            aria-label="Online Shopping Home"
          >
